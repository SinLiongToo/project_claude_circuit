...
("Digital DFT, stress & reliability", [
 ...
 ("Cp","Process capability (Cp)","(USL − LSL) / 6σ: spec width vs process spread."),
 ("Cpk","Process capability index","min(USL − μ, μ − LSL) / 3σ; automotive often ≥ 1.33, critical ≥ 1.67."),
 ("USL","Upper Spec Limit (LSL = Lower Spec Limit)","Design limits; outside them the part is out of spec."),
 ("LSL","Lower Spec Limit",""),
 ("UCL","Upper Control Limit (LCL = Lower Control Limit)","Process limits from history, usually mean ± 3σ."),
 ("LCL","Lower Control Limit",""),
 ("OCAP","Out-of-Control Action Plan","Documented steps when an SPC rule fires."),
 ("MRB","Material Review Board","Decides what happens to held material: release, rework, scrap or deviation."),
 ("MIM","Metal-Insulator-Metal capacitor (MOM = Metal-Oxide-Metal)","Precision on-chip capacitors."),
 ("MOM","Metal-Oxide-Metal (finger) capacitor",""),
("BSIM","Berkeley Short-channel IGFET Model","Industry-standard compact transistor model family used in design kits."),
 ("Vt","Threshold voltage","Gate voltage where the channel turns on; Vt_lin at low Vds, Vt_sat at VDD."),
 ("Idsat","Saturation drain current","Id at Vgs = Vds = VDD, per µm of width; transistor strength."),
 ("Ioff","Off-state leakage current","Id at Vgs = 0, Vds = VDD."),
 ("DIBL","Drain-Induced Barrier Lowering","Vt drop per volt of Vds in short-channel devices."),
 ("SS","Subthreshold swing (also SS = slow-slow process corner)","mV of Vgs per decade of Id below Vt; ≈ 60 mV/dec ideal at room temperature."),
 ("TT","Typical-typical process corner","FF = fast-fast; FS / SF = skewed NMOS / PMOS corners."),
 ("FF","Fast-fast process corner",""),
 ("gm","Transconductance","∂Id/∂Vgs; the transistor's gain."),
 ("gds","Output conductance","∂Id/∂Vds; limits voltage gain (intrinsic gain = gm/gds)."),
 ("Cox","Gate-oxide capacitance per area","εox / Tox."),
 ("Tox","Gate-oxide thickness","Measured with C-V structures in WAT."),
 ("fT","Transit (unity current-gain) frequency","≈ gm / 2π(Cgs + Cgd)."),
 ("fmax","Maximum oscillation (unity power-gain) frequency","Needs ≈ 3–4× the operating frequency for useful gain."),
 ("Vbd","Gate-oxide breakdown voltage","Voltage where oxide current jumps past compliance in a V-ramp test."),
 ("BV","Breakdown Voltage","BVdss = drain-source (gate off), BVj = junction."),
 ("BVdss","Drain-source breakdown voltage","Transistor off-state breakdown; limits PA drain swing."),
 ("BVj","Junction breakdown voltage","Reverse breakdown of N+/P-well or P+/N-well diodes."),
 ("TLP","Transmission-Line Pulse","ESD device characterisation with short, high-current pulses."),
 ("QBD","Charge to breakdown","Total charge an oxide passes before breaking down (reliability)."),
 ("IMD","Inter-Metal Dielectric","Insulator between metal lines/layers; tested with comb structures."),
 ("CMP","Chemical-Mechanical Planarization","Polishing step that flattens each layer; source of centre, edge and ring signatures."),
 ("OPC","Optical Proximity Correction","Mask shape corrections; weak spots (hotspots) can fail per reticle shot."),
 ("EBR","Edge Bead Removal","Removes resist build-up at the wafer edge."),
 ("D0","Defect density","Random defects per unit area; baseline yield Y ≈ e^(−D0·A)."),
...
("PCB, package & materials", [
 ...
 ("FOWLP","Fan-Out Wafer-Level Package","Die embedded in mold with RDL fanning out to balls; eWLB is one type."),
 ("CSP","Chip-Scale Package","Package only slightly larger than the die (FC-CSP = flip-chip CSP)."),
 ("AiP","Antenna-in-Package","Antennas built into package layers."),
 ("IMC","Intermetallic Compound","Layer formed between solder and UBM/pad; grows with time and temperature."),
 ("CTE","Coefficient of Thermal Expansion","Mismatch between materials drives solder and bump fatigue."),
 ("MSL","Moisture Sensitivity Level","J-STD-020 rating: how long a package may sit out of dry pack before reflow."),
 ("ELK","Extreme Low-k dielectric","Fragile back-end dielectric in advanced nodes; cracks under bump stress."),
 ("NSMD","Non-Solder-Mask-Defined pad","PCB pad style that improves solder-joint fatigue life."),
 ("Dk","Dielectric constant","Sets line impedance and antenna tuning; shifts with moisture."),
 ("Df","Dissipation factor","Dielectric loss; key for RF loss at 77 GHz."),
 ("C-SAM","C-mode Scanning Acoustic Microscopy","Non-destructive imaging of delamination and voids."),
 ("PBO","Polybenzoxazole","Polymer dielectric used in RDL (like polyimide)."),
 ("EOS","Electrical Overstress","Damage from overvoltage or overcurrent beyond ESD events."),
